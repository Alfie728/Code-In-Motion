...
export default function TabsClipPath() {
  ...
  return (
    <div className="relative flex flex-col items-center w-fit max-w-[500px] mx-auto rounded-full bg-white">
        ...
        {TABS.map((tab) => (
          <li key={tab.name}>
            <button
              ...
              className="flex h-[34px] items-center gap-2 rounded-full p-4 text-sm font-medium text-black no-underline"
            >
              {tab.icon}
              {tab.name}
            </button>
